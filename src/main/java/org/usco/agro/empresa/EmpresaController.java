	...
	public ResponseEntity<String> createEmpresa(@RequestBody Empresa empresa) {
		try {
			empresaRepository.create(
					new Empresa(empresa.getEmp_tipo_identificacion_id(), empresa.getEmp_identificacion(), empresa.getEmp_nombre(), empresa.getEmp_persona_id(), empresa.getEmp_descripcion(), empresa.getEmp_estado()));
