	...
	public ResponseEntity<String> createEspacio_ocupacion(@RequestBody Espacio_ocupacion espacio_ocupacion) {
		try {
			espacio_ocupacionRepository.create(
					new Espacio_ocupacion(espacio_ocupacion.getEso_espacio_id(), espacio_ocupacion.getEso_actividad_ocupacion_id(), espacio_ocupacion.getEso_fecha_inicio(), espacio_ocupacion.getEso_fecha_fin(), espacio_ocupacion.getEso_estado()));
