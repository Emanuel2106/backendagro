	...
	public ResponseEntity<String> createCosto_indirecto(@RequestBody Costo_indirecto costo_indirecto) {
		try {
			costo_indirectoRepository.create(
					new Costo_indirecto(costo_indirecto.getCoi_espacio_id(), costo_indirecto.getCoi_tipo_costo_indirecto_id(), costo_indirecto.getCoi_fecha_inicio(), costo_indirecto.getCoi_fecha_fin(), costo_indirecto.getCoi_nombre(), costo_indirecto.getCoi_precio(), costo_indirecto.getCoi_descripcion(), costo_indirecto.getCoi_estado()));
