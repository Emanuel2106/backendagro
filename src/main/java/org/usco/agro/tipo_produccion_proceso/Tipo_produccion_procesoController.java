	...
	public ResponseEntity<String> createTipo_produccion_proceso(@RequestBody Tipo_produccion_proceso tipo_produccion_proceso) {
		try {
			tipo_produccion_procesoRepository.create(
					new Tipo_produccion_proceso(tipo_produccion_proceso.getTpp_tipo_produccion_id(), tipo_produccion_proceso.getTpp_proceso_id(), tipo_produccion_proceso.getTpp_descripcion(), tipo_produccion_proceso.getTpp_estado()));
