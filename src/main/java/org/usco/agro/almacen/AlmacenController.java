	...
	public ResponseEntity<String> createAlmacen(@RequestBody Almacen almacen) {
		try {
			almacenRepository.create(
					new Almacen(almacen.getAlm_nombre(), almacen.getAlm_sede_id(), almacen.getAlm_geolocalizacion(), almacen.getAlm_coordenadas(), almacen.getAlm_descripcion(), almacen.getAlm_estado()));
