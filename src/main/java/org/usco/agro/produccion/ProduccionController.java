	...
	public ResponseEntity<String> createProduccion(@RequestBody Produccion produccion) {
		try {
			produccionRepository.create(
					new Produccion(produccion.getPro_nombre(), produccion.getPro_tipo_produccion_id(), produccion.getPro_descripcion(), produccion.getPro_fecha_inicio(), produccion.getPro_fecha_final(), produccion.getPro_espacio_id(), produccion.getPro_estado()));
