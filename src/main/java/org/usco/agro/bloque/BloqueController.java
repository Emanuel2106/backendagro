	...
	public ResponseEntity<String> createBloque(@RequestBody Bloque bloque) {
		try {
			bloqueRepository.create(
					new Bloque(bloque.getBlo_sede_id(), bloque.getBlo_tipo_bloque_id(), bloque.getBlo_nombre(), bloque.getBlo_geolocalizacion(), bloque.getBlo_coordenadas(), bloque.getBlo_numero_pisos(), bloque.getBlo_descripcion(), bloque.getBlo_estado()));
