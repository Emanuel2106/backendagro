	...
	public ResponseEntity<String> createEspacio(@RequestBody Espacio espacio) {
		try {
			espacioRepository.create(
					new Espacio(espacio.getEsp_bloque_id(), espacio.getEsp_tipo_espacio_id(), espacio.getEsp_nombre(), espacio.getEsp_geolocalizacion(), espacio.getEsp_coordenadas(), espacio.getEsp_descripcion(), espacio.getEsp_estado()));
